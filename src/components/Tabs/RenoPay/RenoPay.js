              ...
              <Ripple
                ...
                onPress={() =>
                  this.props.navigation.navigate('EnterAmountScreen', {
                    imageurl: this.props.reservations.orders.upcomingOrders[0]
                      .restaurants.imageurl,
                    name: this.props.reservations.orders.upcomingOrders[0]
                      .restaurants.name,
                    city: this.props.reservations.orders.upcomingOrders[0]
                      .restaurants.city,
                  })
                }>
                <Image
